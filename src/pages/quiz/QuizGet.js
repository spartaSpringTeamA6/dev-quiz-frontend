...
export default function QuizGet(props) {
  ...
  const clickPassHandler = async () => {
    setSelectAnswer(0);
    const response = await quizSubmitPassApi(quiz.id);
              ...
              <AnswerContainer>
                <Answer>
                  {!submitAnswer ? (
                    ...
                    >
                      {quiz.quizChoices[0].choiceContent}
                    </AnswerText>
                  ) : (
                    <SubmitAnswerText
                      color={() => customColor(1)}
                ...
                <Answer>
                  {!submitAnswer ? (
                    ...
                    >
                      {quiz.quizChoices[1].choiceContent}
                    </AnswerText>
                  ) : (
                    <SubmitAnswerText
                      color={() => customColor(2)}
                ...
                <Answer>
                  {!submitAnswer ? (
                    ...
                    >
                      {quiz.quizChoices[2].choiceContent}
                    </AnswerText>
                  ) : (
                    <SubmitAnswerText
                      color={() => customColor(3)}
                ...
                <Answer>
                  {!submitAnswer ? (
                    ...
                    >
                      {quiz.quizChoices[3].choiceContent}
                    </AnswerText>
                  ) : (
                    <SubmitAnswerText
                      color={() => customColor(4)}
